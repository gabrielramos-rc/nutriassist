      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          <div
            ...
            className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-green-500 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors cursor-pointer"
          ...
          >
            ...
            {file ? (
              <div className="flex flex-col items-center">
                <FileText className="w-12 h-12 text-green-600 mb-3" aria-hidden="true" />
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm text-gray-500 mt-1">Maximo 10MB</p>
              </div>
            )}
          </div>
