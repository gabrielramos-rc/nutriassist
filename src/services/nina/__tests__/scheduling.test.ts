...
const mockSlots: AppointmentSlot[] = [
  {
    ...
    formatted: "qua 15/01 às 09:00",
  },
  {
    startsAt: "2025-01-15T10:00:00Z",
    endsAt: "2025-01-15T11:00:00Z",
    formatted: "qua 15/01 às 10:00",
  },
  {
    startsAt: "2025-01-16T09:00:00Z",
    endsAt: "2025-01-16T10:00:00Z",
    formatted: "qui 16/01 às 09:00",
  },
];
...
describe("handleScheduling", () => {
  ...
  describe("check_availability sub-intent", () => {
    ...
    it("returns available slots", async () => {
      ...
      const result = await handleScheduling(
