...
describe("openrouter", () => {
  ...
  describe("generateResponse", () => {
    it("throws error when API key is missing", async () => {
      ...
      await expect(generateResponse([{ role: "user", content: "hello" }])).rejects.toThrow(
    ...
    it("uses explicit model when provided", async () => {
      ...
      await generateResponse([{ role: "user", content: "hello" }], { model: "custom-model" });
  ...
  describe("chat helper", () => {
    ...
    it("includes conversation history", async () => {
      ...
      await chat("System prompt", "New message", [
